      ...
      <form className="border border-dark  rounded p-4">
        ...
        <div className="d-sm-flex gap-5 my-5">
          <div className="form-group flex-fill">
            ...
            <input className="form-control" id="lname" placeholder="Votre nom" />
          </div>
          <div className="form-group flex-fill">
            <label htmlFor="fname">Prénom</label>
            <input className="form-control" id="fname" placeholder="Votre prénom" />
          </div>
        </div>
        <div className="d-flex gap-5 my-5">
          <div className="form-group flex-fill">
            <label htmlFor="email">Email</label>
            <input className="form-control" id="email" placeholder="Votre Email" />
          </div>
          <div className="form-group flex-fill">
            <label htmlFor="tel">Téléphone</label>
            <input className="form-control" id="tel" placeholder="Votre numéro de téléphone" />
          </div>
        </div>
        <div className="d-flex gap-5 my-5">
          <div className="form-group flex-fill">
            <label htmlFor="password">Password</label>
            <input type="password" className="form-control" id="password" placeholder="Votre Password" />
          </div>
          <div className="form-group flex-fill">
